...
const QString WorkflowProgressWidget::BUTTON_STYLE_INACTIVE = 
    "QPushButton { "
    "border-radius: 20px; "
...
const QString WorkflowProgressWidget::BUTTON_STYLE_CURRENT = 
    "QPushButton { "
    "border-radius: 20px; "
...
const QString WorkflowProgressWidget::BUTTON_STYLE_COMPLETE = 
    "QPushButton { "
    "border-radius: 20px; "
...
const QString WorkflowProgressWidget::BUTTON_STYLE_DISABLED = 
    "QPushButton { "
    "border-radius: 20px; "
...
const QString WorkflowProgressWidget::CONNECTOR_STYLE_INACTIVE = 
    "QFrame { "
    "background-color: #E0E0E0; "
    "border: none; "
    "min-height: 2px; "
...
const QString WorkflowProgressWidget::CONNECTOR_STYLE_COMPLETE = 
    "QFrame { "
    "background-color: #4CAF50; "
    "border: none; "
    "min-height: 2px; "
...
void WorkflowProgressWidget::setStepComplete(RegistrationStep step, bool complete)
{
    ...
    if (it != stepIndicators_.end() && it.value().isComplete != complete) {
        ...
        updateConnectors();
        qDebug() << "WorkflowProgressWidget: Step" << getStepName(step) 
...
void WorkflowProgressWidget::setStepEnabled(RegistrationStep step, bool enabled)
{
    ...
    if (it != stepIndicators_.end() && it.value().isEnabled != enabled) {
        ...
        updateStepButton(step);
        qDebug() << "WorkflowProgressWidget: Step" << getStepName(step) 
                 << "enabled status changed to" << enabled;
    }
}

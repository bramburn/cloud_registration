...
{
    registerPreference({"general/autoSave",
                        "Auto Save",
    ...
    registerPreference({"general/autoSaveInterval",
                        "Auto Save Interval",
    ...
    registerPreference({"general/recentFilesCount",
                        "Recent Files Count",
    ...
    registerPreference({"general/confirmExit",
                        "Confirm Exit",
...
{
    registerPreference({"interface/theme",
                        "Theme",
                        "Application theme",
    ...
    registerPreference({"interface/fontSize",
                        "Font Size",
                        "Base font size",
                        PreferenceType::Integer,
                        10,
    ...
    registerPreference({"interface/showToolTips",
                        "Show Tool Tips",
    ...
    registerPreference({"interface/animationsEnabled",
                        "Enable Animations",
...
{
    registerPreference({"performance/maxThreads",
                        "Max Threads",
    ...
    registerPreference({"performance/memoryLimit",
                        "Memory Limit (GB)",
    ...
    registerPreference({"performance/enableGPU",
...
{
    registerPreference({"rendering/pointSize",
                        "Point Size",
    ...
    registerPreference({"rendering/backgroundColor",
                        "Background Color",
    ...
    registerPreference({"rendering/lodEnabled",
                        "Enable LOD",
    ...
    registerPreference({"rendering/maxFPS",
                        "Max FPS",
                        "Maximum frame rate",
                        PreferenceType::Integer,
                        60,
...
{
    registerPreference({"registration/icpMaxIterations",
                        "ICP Max Iterations",
    ...
    registerPreference({"registration/icpTolerance",
                        "ICP Tolerance",
    ...
    registerPreference({"registration/sphereRadius",
                        "Default Sphere Radius",
                        "Default sphere target radius (mm)",
                        PreferenceType::Double,
                        75.0,
                        10.0,
                        500.0,
...
{
    registerPreference({"export/defaultFormat",
    ...
    registerPreference({"export/compressionEnabled",
                        "Enable Compression",
...
{
    registerPreference({"advanced/debugMode",
                        "Debug Mode",
    ...
    registerPreference({"advanced/profilingEnabled",
                        "Enable Profiling",
...
// Typed setters
void UserPreferences::setBool(const QString& key, bool value)
{
    setValue(key, value);
}
void UserPreferences::setInt(const QString& key, int value)
{
    setValue(key, value);
}
void UserPreferences::setDouble(const QString& key, double value)
{
    setValue(key, value);
}
void UserPreferences::setString(const QString& key, const QString& value)
{
    setValue(key, value);
}
void UserPreferences::setStringList(const QString& key, const QStringList& value)
{
    setValue(key, value);
}
void UserPreferences::setColor(const QString& key, const QColor& value)
{
    setValue(key, value);
}
void UserPreferences::setFont(const QString& key, const QFont& value)
{
    setValue(key, value);
}
void UserPreferences::setSize(const QString& key, const QSize& value)
{
    setValue(key, value);
}
void UserPreferences::setPoint(const QString& key, const QPoint& value)
{
    setValue(key, value);
}
void UserPreferences::setByteArray(const QString& key, const QByteArray& value)
{
    setValue(key, value);
}

// Window layout management
void UserPreferences::saveWindowLayout(const QString& name,
                                       const QByteArray& geometry,
                                       const QByteArray& windowState,
                                       const QMap<QString, QVariant>& customData)
{
...
QString UserPreferences::getValidationError(const QString& key, const QVariant& value) const
{
    ...
    if (!validateValueRange(convertedValue, def.minValue, def.maxValue))
    {
        return QString("Value for %1 is out of range [%2, %3]")
            .arg(key, def.minValue.toString(), def.maxValue.toString());
    }
...
bool UserPreferences::validateValueRange(const QVariant& value,

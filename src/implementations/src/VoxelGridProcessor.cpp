...
IPointCloudProcessor::ProcessingResult VoxelGridProcessor::processPointCloud(const std::vector<Point3D>& points,
                                                                             const QString& parameters)
{
    ...
    try
    {
        ...
        for (const auto& voxelPair : voxelGrid)
        {
            ...
            Point3D processedPoint = params.useAveraging ? averagePoints(voxelPoints) : voxelPoints[0];

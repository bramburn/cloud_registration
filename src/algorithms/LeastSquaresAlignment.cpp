...
bool LeastSquaresAlignment::validateCorrespondences(const QList<QPair<QVector3D, QVector3D>>& correspondences)
{
...
QMatrix4x4 LeastSquaresAlignment::assembleTransformationMatrix(const float rotation[9], const float translation[3])
{

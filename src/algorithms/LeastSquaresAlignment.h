...
private:
     ...
     */
    static bool validateCorrespondences(const QList<QPair<QVector3D, QVector3D>>& correspondences);
     ...
     */
    static QMatrix4x4 assembleTransformationMatrix(const float rotation[9], const float translation[3]);

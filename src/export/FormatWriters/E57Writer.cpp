...
void E57Writer::writeXMLHeader()
{
    ...
    *m_stream << "  <guid type=\"String\"><![CDATA[{" << QUuid::createUuid().toString(QUuid::WithoutBraces)
              << "}]]></guid>\n";
    ...
    *m_stream << "  <coordinateMetadata type=\"String\"><![CDATA[" << m_headerInfo.coordinateSystem
              << "]]></coordinateMetadata>\n";

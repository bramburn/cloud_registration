...
bool XYZWriter::writePoint(const Point& point)
{
    ...
    *m_stream << point.x << m_separator << point.y << m_separator << point.z;
    ...
    switch (m_format)
    {
        ...
        case Format::XYZRGB:
            *m_stream << m_separator << static_cast<int>(point.r) << m_separator << static_cast<int>(point.g)
                      << m_separator << static_cast<int>(point.b);
            break;

        case Format::XYZIRGB:
            *m_stream << m_separator << point.intensity << m_separator << static_cast<int>(point.r) << m_separator
                      << static_cast<int>(point.g) << m_separator << static_cast<int>(point.b);
            break;
    }

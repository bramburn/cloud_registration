...
CoordinateSystemManager::CoordinateSystemManager(QObject* parent)
    : QObject(parent)
...
TransformationParameters CoordinateSystemManager::getTransformationParameters(
    const QString& sourceCRS, const QString& targetCRS) const
{
                                                           ...
                                                           const QString& targetCRS) const
{
    ...
    qDebug() << "CoordinateSystemManager: Transformed" << points.size() << "points from" << sourceCRS << "to" << targetCRS;

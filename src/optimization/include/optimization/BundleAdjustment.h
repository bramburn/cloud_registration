...
public:
     ...
     */
    std::pair<std::unique_ptr<Registration::PoseGraph>, Result> optimize(const Registration::PoseGraph& initialGraph,
...
private:
    ...
    public:
        ...
        const QList<int>& getOptimizedNodes() const
        {
     ...
     */
    double calculateTotalError(const StateVector& state, const Registration::PoseGraph& graph) const;

...
public:
     ...
     */
    QList<QPair<Features::Plane, Features::Plane>> findPlaneCorrespondences(const QList<Features::Plane>& sourcePlanes,
     ...
     */
    QMatrix4x4 computeTransformFromPlanes(const QList<QPair<Features::Plane, Features::Plane>>& correspondences);
...
private:
     ...
     */
    QMatrix4x4 solveForRotation(const QList<QVector3D>& sourceNormals, const QList<QVector3D>& targetNormals) const;
     ...
     * @return RMS error
     */
    float calculateRegistrationError(const QList<QPair<Features::Plane, Features::Plane>>& correspondences,

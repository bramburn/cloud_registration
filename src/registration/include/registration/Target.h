...
public:
    ...
    void setScanId(const QString& id)
    {
        scanId_ = id;
    }
...
public:
    ...
    float rmsError() const
    {
        return rmsError_;
    }
    void setRmsError(float error)
    {
        rmsError_ = error;
    }
...
public:
    ...
    void setCornerPoints(const QList<QVector3D>& corners)
    {
    ...
    float planeError() const
    {
        return planeError_;
    }
    void setPlaneError(float error)
    {
        planeError_ = error;
    }
...
public:
    ...
    float distinctiveness() const
    {
        return distinctiveness_;
    }
    void setDistinctiveness(float distinctiveness)
    {
        distinctiveness_ = distinctiveness;
    }
    ...
    {
        neighborCount_ = count;
    }

    // Feature descriptor (for matching)
    QList<float> featureDescriptor() const
    {
        return featureDescriptor_;
    }
    void setFeatureDescriptor(const QList<float>& descriptor)
    {
        featureDescriptor_ = descriptor;
    }

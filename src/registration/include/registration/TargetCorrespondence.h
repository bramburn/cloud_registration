...
public:
    ...
    TargetCorrespondence(const QString& targetId1,
                         const QString& targetId2,
                         const QString& scanId1,
                         const QString& scanId2);

    // Basic properties
    QString targetId1() const
    {
        return targetId1_;
    }
    void setTargetId1(const QString& id)
    {
        targetId1_ = id;
    }

    QString targetId2() const
    {
        return targetId2_;
    }
    void setTargetId2(const QString& id)
    {
        targetId2_ = id;
    }

    QString scanId1() const
    {
        return scanId1_;
    }
    void setScanId1(const QString& id)
    {
        scanId1_ = id;
    }

    QString scanId2() const
    {
        return scanId2_;
    }
    void setScanId2(const QString& id)
    {
        scanId2_ = id;
    }
    ...
    void setResidualError(float error)
    {
        residualError_ = error;
    }

...
public:
     ...
     */
    static float calculateRMSError(const QList<QPair<QVector3D, QVector3D>>& correspondences,
     ...
     */
    static ErrorStatistics calculateErrorStatistics(const QList<QPair<QVector3D, QVector3D>>& correspondences,
                                                    const QMatrix4x4& transform);
     ...
     */
    static QList<float> calculateIndividualErrors(const QList<QPair<QVector3D, QVector3D>>& correspondences,
                                                  const QMatrix4x4& transform);
     ...
     */
    static QList<int> identifyOutliers(const QList<QPair<QVector3D, QVector3D>>& correspondences,
                                       const QMatrix4x4& transform,
     ...
     */
    static float calculateConditionNumber(const QList<QPair<QVector3D, QVector3D>>& correspondences);

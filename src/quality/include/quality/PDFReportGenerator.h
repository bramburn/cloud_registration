...
private:
    // Layout helpers
    int drawText(QPainter& painter, const QString& text, const QRect& rect, 
    ...
    void drawBarChart(QPainter& painter, const QRect& rect, 
                     ...
                     const QString& title);
    void drawGaugeChart(QPainter& painter, const QRect& rect, 
    ...
    void setCurrentY(int y) { m_currentY = y; }
    void addVerticalSpace(int space) { m_currentY += space; }
    ...
    struct PageLayout {
        ...
        int contentWidth() const { return pageWidth - leftMargin - rightMargin; }
        int contentHeight() const { return pageHeight - topMargin - bottomMargin; }
    };

#!/usr/bin/env python3
"""
Create test E57 files for Sprint 2.1 codec testing
"""
...
<e57Root type="Structure" xmlns="http://www.astm.org/COMMIT/E57/2010-e57-v1.0">
    ...
    <data3D type="Vector" allowHeterogeneousChildren="1">
        <vectorChild type="Structure">
            ...
            <points type="CompressedVector" fileOffset="''' + str(48 + 1000) + '''" recordCount="3">
    ...
    # Create the file
    filename = "test_data/e57_bitpack_codec_test.e57"
...
<e57Root type="Structure" xmlns="http://www.astm.org/COMMIT/E57/2010-e57-v1.0">
        ...
        <vectorChild type="Structure">
            <points type="CompressedVector" recordCount="3">
                ...
                <codecs type="Vector">
                    <vectorChild type="CompressedVectorNode">
                        <recordCount type="Integer">3</recordCount>
                        <codec type="String">zLibCodec</codec>
                    </vectorChild>
                </codecs>
            </points>
        </vectorChild>
    ...
    filename = "test_data/e57_unsupported_codec_test.e57"
...
if __name__ == "__main__":
    ...
    print("Test E57 files created successfully!")

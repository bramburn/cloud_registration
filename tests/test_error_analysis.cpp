...
TEST_F(ErrorAnalysisTest, RMSErrorCalculation)
{
    ...
    QList<QVector3D> targetPoints = {
        QVector3D(0.1f, 0.0f, 0.0f), QVector3D(1.1f, 0.0f, 0.0f), QVector3D(0.0f, 1.1f, 0.0f)};
...
TEST_F(ErrorAnalysisTest, MaxErrorCalculation)
{
    ...
    QList<QVector3D> targetPoints = {QVector3D(0.1f, 0.0f, 0.0f), QVector3D(1.2f, 0.0f, 0.0f)};

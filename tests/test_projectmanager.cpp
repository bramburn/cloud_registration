...
{
    EXPECT_THROW(m_projectManager->createProject("TestProject", "/invalid/path/that/does/not/exist"),
...
TEST_F(ProjectManagerTest, OpenInvalidProject)
{
    ...
    EXPECT_THROW(m_projectManager->loadProject(invalidPath), ProjectLoadException);
}
...
TEST_F(ProjectManagerTest, OpenCorruptedProject)
{
    ...
    EXPECT_THROW(m_projectManager->loadProject(projectPath), ProjectLoadException);
}

TEST_F(ProjectManagerTest, CreateProjectInvalidName)
{
    EXPECT_THROW(m_projectManager->createProject("", m_testBasePath), ProjectCreationException);

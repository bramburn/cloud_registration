...
protected:
    ...
    generateSpherePoints(const QVector3D& center, float radius, int numPoints, float noise = 0.0f)
    {
    ...
    std::vector<PointFullData>
    generateNoisePoints(int numPoints, const QVector3D& minBounds, const QVector3D& maxBounds)
    {
        std::vector<PointFullData> points;
        points.reserve(numPoints);

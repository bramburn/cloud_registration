...
public:
    ...
    void setupEmptyViewer() {
        ...
        ON_CALL(*this, hasData())
            .WillByDefault(Return(false));
        
        ON_CALL(*this, pointCount())
            .WillByDefault(Return(0));
        
        ON_CALL(*this, getState())
            .WillByDefault(Return(ViewerState::Empty));
    }
    ...
    void setupLoadedViewer(size_t numPoints = 300) {
        ...
        ON_CALL(*this, pointCount())
            .WillByDefault(Return(numPoints));
        
        ON_CALL(*this, getState())
            .WillByDefault(Return(ViewerState::Ready));
    }
    ...
    void setupLoadingViewer() {
        ...
        ON_CALL(*this, getState())
            .WillByDefault(Return(ViewerState::Loading));
    }
    ...
    void setupErrorViewer(const QString& errorMessage = "Mock viewer error") {
        ...
        ON_CALL(*this, getState())
            .WillByDefault(Return(ViewerState::Error));
    }
    ...
    void setupRenderingViewer(size_t numPoints = 300) {
        ...
        ON_CALL(*this, getState())
            .WillByDefault(Return(ViewerState::Rendering));
    }
    ...
    void verifyPointCloudLoaded(const std::vector<float>& expectedPoints) {
        ...
        EXPECT_CALL(*this, loadPointCloud(expectedPoints))
            .Times(1);
    }

    void verifyViewerCleared() {
        EXPECT_CALL(*this, clearPointCloud())
            .Times(1);
    }

    void verifyCameraReset() {
        EXPECT_CALL(*this, resetCamera())
            .Times(1);
    }
    ...
    void verifyStateSet(ViewerState expectedState, const QString& expectedMessage = QString()) {
        ...
        if (expectedMessage.isEmpty()) {
            EXPECT_CALL(*this, setState(expectedState, _))
                .Times(1);
        } else {
            EXPECT_CALL(*this, setState(expectedState, expectedMessage))
                .Times(1);
        }
    }
    ...
    void verifyRenderingSettingsApplied() {
        ...
        EXPECT_CALL(*this, setPointSize(_))
            .Times(::testing::AtLeast(0));
        
        EXPECT_CALL(*this, setLODEnabled(_))
            .Times(::testing::AtLeast(0));
        
        EXPECT_CALL(*this, setRenderWithColor(_))
            .Times(::testing::AtLeast(0));
        
        EXPECT_CALL(*this, setRenderWithIntensity(_))
            .Times(::testing::AtLeast(0));
    }
};
